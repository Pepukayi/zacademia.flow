    ...
    <nav aria-label="Progress" class="mb-4">
        <ol role="list" class="divide-y divide-gray-300 rounded-md border border-gray-300 md:flex md:divide-y-0">
          ...
          <span class="flex items-center px-6 py-4 text-sm font-medium">
            <span class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-mostepe-green-dark group-hover:bg-mostepe-green-light">
          ...
          <span class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border-2 border-mostepe-green-dark">
            <span class="text-mostepe-green-dark">{{ step.id }}</span>
          </span>
                    <span class="ml-4 text-sm font-medium text-mostepe-green-dark">{{ step.name }}</span>
                </a>
