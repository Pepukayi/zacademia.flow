    ...
    <ApplicationAppLayout :steps="steps" :progressPercent="progressPercent" :height="'h-[900px]'">
        ...
        <form @submit.prevent="submit">
            <div class="m-2 grid justify-center items-center">
                <div class="block mt-3 col-span-full w-96">
                    ...
                    <div class="mt-1">
                        <SelectDropdown
                            ...
                            :name="'working_parents_guardians'"
                            @update:modelValue="(value) => appData.personal_information.working_parents_guardians = value"/>
                        <InputError class="mt-2" :message="form.errors.working_parents_guardians"/>
                    </div>
                </div>

                <div v-if="appData.personal_information.working_parents_guardians === 'None'" class="col-span-full mt-3">
                ...
                <div v-if="appData.personal_information.working_parents_guardians === 'I am an orphan'" class="col-span-full mt-3">
                ...
                <div v-if="appData.personal_information.working_parents_guardians === 'One parent/guardian is working'" class="col-span-full mt-3">
                ...
                <div v-if="appData.personal_information.working_parents_guardians === 'Both parents/guardians are working'" class="col-span-full mt-3">
                    <InputLabel value="Annual income of your parent/guardian" />
                    <div class="mt-1">
                        <TextInput
                            v-model="appData.personal_information.parent_annual_income"
