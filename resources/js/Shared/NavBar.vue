...
const navigation = [
    ...
    { name: 'Global Investment Portfolio', href: '/portfolio' },
    { name: 'Colmin Group Coin', href: '/group-coin' },
        ...
        <nav class="flex items-center justify-between  lg:px-8" aria-label="Global">
            <div class="flex lg:flex-1">
                <a href="/" class="-m-1.5 p-0">
                    ...
                    <img class="h-40 w-auto" src="/logos/COLMIN%20GROUP.png" alt="" />
            ...
            <DialogPanel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                <div class="flex items-center justify-between">
                    <a href="#" class="-m-1.5 p-1.5">
                        <span class="sr-only">Your Company</span>
                        <img class="h-8 w-auto" src="/logos/COLMIN%20GROUP.png" alt="" />
